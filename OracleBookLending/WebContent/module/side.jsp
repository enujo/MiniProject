	...
	<div class="w3-container w3-row"> 
		...
		<c:if test="${userId ne null}">
		    ...
		    <div class="w3-col s8">
		      ...
		      <a type="hidden" href="<c:url value='/MemberDetail.me?mID=${userId }'/>"class="w3-hover-none w3-hover-text-green w3-show-inline-block"><i class="fa fa-user"></i></a>
