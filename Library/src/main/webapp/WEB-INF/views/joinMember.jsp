	...
	<div class="w3-container" id="where" style="padding-bottom: 32px;">
		<div class="w3-content" style="max-width: 700px">
			...
			<form action="joinMember" method="post">
				...
				<p>
					<input class="w3-radio" type="radio" name="libmemberState" value="1" checked> <label class="w3-validate">회비 납부</label>
					<input class="w3-radio" type="radio" name="libmemberState" value="0"> <label class="w3-validate">납부 안함</label>
				</p>
				<p>
